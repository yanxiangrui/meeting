        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
                ...
                <div class="layui-card"> 
                    <div class="layui-card-header">酒店房间管理</div>

                    <div class="layui-card-body">                        

                        <blockquote class="layui-elem-quote ">
                            <div class="layui-btn-group">
                                <a lay-tips="添加" class="layui-btn layui-btn-normal layui-btn-sm" href="{{ route('hotel_rooms.create') }}" ><i class="layui-icon layui-icon-add-1">&#xe654;</i> 添加</a> 
