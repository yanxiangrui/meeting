        ...
        <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
                ...
                <div class="layui-card"> 
                    <div class="layui-card-header">会议管理</div>

                    <div class="layui-card-body">                        

                        <blockquote class="layui-elem-quote ">
                            <div class="layui-btn-group">
                                <a lay-tips="添加" class="layui-btn layui-btn-normal layui-btn-sm" href="{{ route('meeting_journeys.create') }}" ><i class="layui-icon layui-icon-add-1">&#xe654;</i> 添加</a> 
    ...
    <script type="text/javascript">
        layui.config({
            ...
            table.render({
                ...
                ,url: '{{ route("meeting_journeys.index") }}'
                ,cellMinWidth: 80
                ,loading: true
                ,cols: [[
                    {type:'numbers'}
            ...
            table.on('tool(hotel-table-form)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'edit'){ //查看
                    location.href = "meeting_journeys/" + data.id + "/edit";
