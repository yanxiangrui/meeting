            ...
            <div class="layui-card-body" style="padding: 15px;">
                <form class="layui-form" action="{{ route('hotel_rooms.store') }}" method="POST" lay-filter="component-form-group">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block"> 
                            <input type="text" name="title" lay-verify="required" placeholder="名称" value="{{ old('title') }}" class="layui-input"> 
                        </div> 
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <input type="text" name="price" lay-verify="required" placeholder="费用" value="{{ old('price') }}" class="layui-input">
                        </div>
                    </div>  
