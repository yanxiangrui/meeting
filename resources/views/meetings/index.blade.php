                    ...
                    <div class="layui-card-body">                        
                        ...
                        <blockquote class="layui-elem-quote ">
                            <div class="layui-btn-group">
                                <a lay-tips="添加" class="layui-btn layui-btn-normal layui-btn-sm" href="{{ route('meetings.create') }}" ><i class="layui-icon layui-icon-add-1">&#xe654;</i> 添加</a> 
    ...
    <script type="text/javascript">
        layui.config({
            ...
            table.on('tool(hotel-table-form)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
                ...
                if(layEvent === 'edit'){ //查看
                    location.href = "meetings/" + data.id + "/edit";
